...
export default function Header() {
  return (
    <div className="bg-brand-color">
      <div className='container mx-auto h-14 md:h-11 flex items-center justify-center md:justify-between'>
        ...
        <nav className="hidden md:flex gap-x-8 text-sm font-semibold">
          <a href="#" className="flex items-center gap-x-2 text-white opacity-80 hover:opacity-100">
            <BiGlobe size={20}/>
            Türkçe(TR) 
          </a>
